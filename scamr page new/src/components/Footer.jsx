...
export const Footer = () => {
  return (
    <footer className="bg-[#111111] backdrop-sepia text-gray-300 py-12 px-6">
        ...
        <div>
          ...
          <div className="flex space-x-3 mt-6">
            ...
            <a
              ...
              className="w-8 h-8 rounded-full bg-gray-800 text-gray-400 hover:text-white hover:bg-gray-700 flex items-center justify-center transition-all duration-200"
            >
              <svg
                width="14"
                height="14"
